 ...
 *
 * Read digraph6 strings from the standard input and print those that are bi-nut digraphs.
 */
...
int main() {
	...
	long long binut_digraph_count = 0;
	...
	while (fgets(line, sizeof(line), stdin)) {
		...
		// The in-degree and out-degree of every vertex of a bi-nut digraph is at least 2
		discard = false;
		for (int i=0; i<n; i++) {
	...
	fprintf(stderr, "> Total number of bi-nut digraphs: %lld\n", binut_digraph_count);
	return 0;
}
